  ...
  if (isLogin) {
    if (form.email && form.password) {
      const dummyProfile = {
        ...
        email: form.email,
        profileImage: '/images/admin_avatar.png', // ✅ default image
      };

      localStorage.setItem('adminProfile', JSON.stringify(dummyProfile)); // ✅ store it
      alert(`Welcome Admin ${form.email}`);
